#Users - id, NAME , birth, gender, hp, email, point, level, addr, regdate
# 이메일 부분 유니크키라 NULL 중복 안됨. 편하게 할 수 있는 방법 찾아보기
...
#Products - proNo, cateNo, sellerNp, prodName, prodPrice, prodStock, prodSold, prodDiscount
INSERT INTO `Products` VALUES ('100101', '11', '10003', '반팔티 L~2XL', '25000', '869', '132', '20');
INSERT INTO `Products` VALUES ('100110', '10', '10004', '트레이닝 통바지', '38000', '1602', '132', '15');
INSERT INTO `Products` VALUES ('110101', '10', '10003', '신상 여성운동화', '76000', '160', '132', '5');
INSERT INTO `Products` VALUES ('120101', '12', '10010', '암소 1등급 구이셋트 1.2kg', '150000', '0', '132', '15');
INSERT INTO `Products` VALUES ('120103', '12', '10010', '바로구이 부채살 250g', '21000', '0', '132', '10');
INSERT INTO `Products` VALUES ('130101', '13', '10006', '[ANF] 식스프리 강아지 사료', '56000', '58', '132', '0');
INSERT INTO `Products` VALUES ('130112', '13', '10006', '중대형 사계절 강아지옷', '15000', '120', '132', '0');
INSERT INTO `Products` VALUES ('141001', '14', '10001', '라떼 2인 소파/방수 패브릭', '320000', '0', '132', '0');
INSERT INTO `Products` VALUES ('170115', '17', '10007', '지포스 3080 그래픽 카드', '900000', '28', '132', '12');
INSERT INTO `Products` VALUES ('160103', '16', '10009', '치닝디핑 33BR 철봉', '120000', '32', '132', '0');
...
`userId`, `userName`, `userHp`, `userPoint`, `point`

#문제4: 모든 주문의 주문번호, 주문자 아이디, 고객명, 주문가격, 주문일자를 조회하시오. 단 주문금액에 10만원 이상, 큰 금액순으로 조회,  금액이 같으면 이름이 사전순으로 될것
# 금액 >= 100000, Desc, 사전순(name by? (X) `userName` ASC)
`orderNo`, `userId`, `userName`, `orderTotalPrice?`, `orderDate`

#문제5: 모든 주문의 주문번호, 주문자 아이디, 고객명, 상품명, 주문일자를 조회하시오. 주문번호는 중복없이 상품명은 구분자,로 나열할것

`orderNo`, `userId`, `userName`, `prodName`, `orderDate`

#문제6: 모든 상품의 상품번호, 상품명, 상품가격, 할인율, 할인된 가격을 조회하시오.

`prodNo`, `prodName`, `prodPrice`, `prodDiscount`

#문제7: 고소영이 판매하는 모든 상품의 상품번호, 상품명, 상품가격, 재고수량, 판매자 이름을 조회하시오.

`prodNo`, `prodName`, `prodPrice`, `prodStock`, `sellerManager`

#문제8: 아직 상품을 판매하지 않은 판매자의 판매자 번호, 판매자 상호, 판매자 이름, 판매자 연락처를 조회하시오.

`sellerNo`, `sellerBizName`, `sellerManager`, `sellerPhone`

#문제9: 모든 주문상세 내역 중 개별 상품 가격과 개수 그리고 할인율이 적용된 최종 총합을 구하고 
